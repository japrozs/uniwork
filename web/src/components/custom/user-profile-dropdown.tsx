...
export const UserProfileDropdown: React.FC<UserProfileDropdownProps> = ({}) => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="hover:bg-gray-100 rounded-sm p-1 w-full focus:outline-none ml-auto mr-0">
                {data && !loading && (
                ...
                <DropdownMenuLabel>
                    <div className="flex items-center">
                        ...
                        <img
                            ...
                            className="min-w-7 ml-auto object-cover  mr-0 w-7 h-7 flex items-center justify-center rounded-md"
                            height={20}
                            width={20}
                            alt="avatar"
                        />
